    ...
    <div className="container mx-auto mb-16 md:mb-28">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2 p-6 mb-16 md:mb-28">
          <h1 className="text-2xl md:text-3xl font-semibold mb-6">Communities in need To support Our Focus</h1>
          <p className="mb-6">
            ...
            neighborhoods to marginalized groups, we strive to address the most
            pressing issues that can create a lasting impact.
          </p>
          <div className="flex justify-start gap-6 md:gap-14 items-center mb-6">
            <p className="flex justify-center items-center gap-3 md:text-xl">
                <span className=""><FcApproval /></span>
          ...
          <div className="">
           <Link to="/allcampaign"> <button className="py-3 px-6 bg-[#ff5103] text-white">Donate Now</button></Link>
          </div>
        </div>
      </div>
    </div>
